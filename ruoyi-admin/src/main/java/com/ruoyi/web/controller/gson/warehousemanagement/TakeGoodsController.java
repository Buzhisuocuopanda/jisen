...
public class TakeGoodsController extends BaseController {
    ...
    public AjaxResult<TableDataInfo> takeOrderList(@RequestBody TakeGoodsOrderListDto takeGoodsOrderListDto){
        try {
            ...
            log.error("【提货单列表】接口出现异常,参数${}$,异常${}$", JSONUtils.toJSONString(getUserId()), ExceptionUtils.getStackTrace(e));
    ...
    public AjaxResult addTakeGoodsOrder(@RequestBody TakeGoodsOrderAddDto takeGoodsOrderAddDto){
        try {
            ...
            log.error("【添加提货单】接口出现异常,参数${}$,异常${}$", JSONUtils.toJSONString(getUserId()), ExceptionUtils.getStackTrace(e));
    ...
    public AjaxResult<TakeGoodsOrderDetailVo> takeOrderDetail(@RequestParam Integer id){
        try {
            ...
            log.error("【提货单详情】接口出现异常,参数${}$,异常${}$", JSONUtils.toJSONString(getUserId()), ExceptionUtils.getStackTrace(e));
    ...
    public AjaxResult<TakeGoodsOrderDetailVo> takeOrderDetailBySaleId(@RequestParam Integer saleOrderId,@RequestParam Integer whId){
        try {
            ...
            log.error("【根据销售订单id查出提货单信息】接口出现异常,参数${}$,异常${}$", JSONUtils.toJSONString(getUserId()), ExceptionUtils.getStackTrace(e));
    ...
    public AjaxResult mdfTakeGoodsOrder(@RequestBody TakeGoodsOrderAddDto takeGoodsOrderAddDto){
        try {
            ...
            log.error("【提货单编辑】接口出现异常,参数${}$,异常${}$", JSONUtils.toJSONString(getUserId()), ExceptionUtils.getStackTrace(e));
    ...
    public AjaxResult delTakeGoodsOrder(@RequestParam Integer id){
        try {
            ...
            log.error("【提货单删除】接口出现异常,参数${}$,异常${}$", JSONUtils.toJSONString(getUserId()), ExceptionUtils.getStackTrace(e));
    ...
    public AjaxResult auditTakeOrder(@RequestBody AuditTakeOrderDto auditTakeOrderDto){
        try {
            ...
            log.error("【提货单状态更改】接口出现异常,参数${}$,异常${}$", JSONUtils.toJSONString(getUserId()), ExceptionUtils.getStackTrace(e));
