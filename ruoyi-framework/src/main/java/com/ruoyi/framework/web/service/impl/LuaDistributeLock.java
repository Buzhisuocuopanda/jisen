...
import com.ruoyi.framework.web.service.Lock;
...
public class LuaDistributeLock implements Lock {
    ...
    public void init() {
        ...
        lockScript.setScriptSource(
                new ResourceScriptSource(new ClassPathResource("com/ruoyi/framework/web/lock.lua")));
        lockScript.setResultType(Long.class);
        // unlock script
        unlockScript = new DefaultRedisScript<Long>();
        unlockScript.setScriptSource(
                new ResourceScriptSource(new ClassPathResource("com/ruoyi/framework/web/unlock.lua")));
